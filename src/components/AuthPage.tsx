...
export const AuthPage = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-primary/10 to-secondary/10 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        ...
        <CardContent>
          {!showOtp ? <form onSubmit={handleSendOtp} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="otp" type="text" placeholder="123456" value={otp} onChange={e => setOtp(e.target.value)} maxLength={6} required />
